                          ...
                          children: [
                            Expanded(
                              child: Container(
                                ...
                                child: Text(
                                 languageState.currentLanguage == LanguageContant().english ?  "Name" :"Jina",
                          ...
                          child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      text: languageState.currentLanguage == LanguageContant().english ?  'Status ' :"Dhamana",
                                      style: TextStyle().copyWith(
                                        fontSize: 12.0,
                                        fontWeight: FontWeight.w500,
                                        color: Color(0xFF92A791),
                                      ...
                                      children: [
                                        TextSpan(
                                          text:languageState.currentLanguage == LanguageContant().english ? "Quality Controller" :"Mhakiki wa Ubora",
                                          style: TextStyle().copyWith(
                                            fontSize: 12.0,
                                            fontWeight: FontWeight.w500,
                                            color: Color(0xFF9FB9CC),
