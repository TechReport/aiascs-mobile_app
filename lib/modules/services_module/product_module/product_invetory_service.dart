                ...
                children: [
                  ExpansionTile(
                    title: Row(
                      ...
                      children: [
                        Text(
                          languageState.currentLanguage == LanguageContant().english ?   "Authorized Products " :"Bidhaa zinazoruhusiwa",
                          style: TextStyle(
                    ...
                    children: productList.map((Product product) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          Provider.of<AppBarTitleState>(context, listen: false)
                              .setCurrentAppBarTitle(  languageState.currentLanguage == LanguageContant().english ?  "Product Details"
                                  : "Maelezo ya Bidhaa");
                          Navigator.push(
                              context,
                              new MaterialPageRoute(
                  ...
                  ExpansionTile(
                      title: Row(
                        ...
                        children: [
                          Text(
                           languageState.currentLanguage == LanguageContant().english ? "UnAuthorized Products " :"Bidhaa ZisizoTambuliwa",
                            style: TextStyle(
                              color: Color(0xFF264653),
                              fontWeight: FontWeight.bold,
                              fontSize: 17,
